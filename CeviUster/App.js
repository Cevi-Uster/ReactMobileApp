	...
	return (
		<PrivacyStatementStack.Navigator>
			<PrivacyStatementStack.Screen
				...
				initialParams={{
					url: GLOBALS.PRIVACY_STATEMENT_URL,
					title: PRIVACY_TITLE,
				}}
			/>
		</PrivacyStatementStack.Navigator>
			...
			<NavigationContainer>
				...
				>
					...
					<TabNavigator.Screen
						...
						options={{ title: AGENDA_TITLE }}
					/>
					<TabNavigator.Screen
						name={INFOBOX_TITLE}
						component={InfoboxStackScreen}
						options={{ title: INFOBOX_TITLE }}
					/>
					<TabNavigator.Screen
						name={CONTACT_TITLE}
					...
					<TabNavigator.Screen
						name={PRIVACY_TITLE}
						component={PrivacyStatementStackScreen}
						options={{ title: PRIVACY_TITLE }}
					/>
				</TabNavigator.Navigator>
			</NavigationContainer>
		</SafeAreaView>
